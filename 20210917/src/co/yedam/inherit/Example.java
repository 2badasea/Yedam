...
public class Example {
	public static void main(String[] args) {
		People p1 = new People("Hong", "20200101-1234566");
		...
		Student s2 = new Student("Choi", "20200202-1234567", 110);
		System.out.println("이름: " +s2.getName());
		System.out.println("번호: " +s2.getSsn());
		System.out.println("학생번호: " + s2.getStudentNo());
		s2.showInfo();
		
		People p2 = new Student("Hwang", "20200303-1234567", 120);
//		p1 = new Student("Hwang", "20200303-1234567", 120); 
		
//		Student s3 = new People(); 
//		p2.getStudentNu(); 부모클래스 변수 자식클래스에 메소드 호출 불가능.
